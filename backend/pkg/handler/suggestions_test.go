...
func TestHandler_getSuggestionsBySprintId(t *testing.T) {
	...
	testTable := []struct {
	...
	}{
		{
			...
			expectedRequestBody: `{"data":[{"id":1,"author_id":1,"sprint_id":1,
			"author":{"name":"","username":"test","email":"test@mail.ru","pfp_url":"","bio":""},"content":"content","post_date":"","votes":0],}`,
		},
		//{
		//	name:        "Service Failure",
		//	inputUserId: 1,
		//	mockBehavior: func(s *mock_service.MockSuggestion, userId int) {
